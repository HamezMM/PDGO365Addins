...
namespace SpeakerRename
{
    public partial class ThisAddIn
    {
        ...
        internal Ribbon.SpeakerRenameRibbon Ribbon { get; private set; }
        ...
        private void ThisAddIn_Startup(object sender, EventArgs e)
        {
            ...
            Application.DocumentChange += InvalidateRenameButton;
        ...
        private void InvalidateRenameButton() => Ribbon?.InvalidateRenameButton();

        /// <summary>Registers the XML ribbon defined in <see cref="Ribbon.SpeakerRenameRibbon"/>.</summary>
        protected override IRibbonExtensibility CreateRibbonExtensibilityObject()
        {
            Ribbon = new Ribbon.SpeakerRenameRibbon();
            return Ribbon;
        }
